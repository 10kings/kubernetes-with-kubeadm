...
NOTE: These required ports need to be open. Check the official <a href="https://kubernetes.io/docs/reference/networking/ports-and-protocols">kubernetes documentation</a>
...
Step 6: Joining the Worker Nodes
